...
const HINT_MODIFY = HINT_FAKE | HINT_TFO | HINT_OOB | HINT_TCPFRAG | HINT_TLSFRAG | HINT_MINORVER | HINT_REVERSE | HINT_MOVE | HINT_STRIP | HINT_FRONTING
